...
@endif
<h3 style="margin: 60px 0 40px 0; font-size: 50px;font-weight: bold;text-align:center;">Favorites</h3>
@if(count($posts) == 0)
<h3 style="margin: 60px 0 40px 0; font-size: 30px;font-weight: normal;text-align:center;">No favorites yet.</h3>
@else
